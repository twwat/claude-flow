...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalPlugins: 11,
      totalDownloads: 73250,
      totalAuthors: 2,
      featured: ['@claude-flow/neural', '@claude-flow/security', '@claude-flow/plugin-agentic-qe', '@claude-flow/plugin-prime-radiant'],
      trending: ['@claude-flow/embeddings', '@claude-flow/plugin-agentic-qe', '@claude-flow/plugin-prime-radiant', 'plugin-creator'],
      newest: ['@claude-flow/plugin-agentic-qe', '@claude-flow/plugin-prime-radiant', 'custom-agents'],
      official: ['@claude-flow/neural', '@claude-flow/security', '@claude-flow/embeddings', '@claude-flow/claims', '@claude-flow/performance', 'plugin-creator', '@claude-flow/plugin-agentic-qe', '@claude-flow/plugin-prime-radiant'],
      compatibilityMatrix: [
